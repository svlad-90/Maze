import { _decorator, Component, Node, Prefab, Vec2, instantiate, Vec3, UITransform, Graphics, ResolutionPolicy, 
    math, randomRangeInt, Label, Rect, PhysicsSystem2D, ERaycast2DType, Line, Color, Sprite, NodePool, Material, RenderTexture } from 'cc';
...
export namespace Maze_MapBuilder
{
    ...
    class LevelMap
    {
        ...
        private _lightingObstaclesTexture:RenderTexture|null = null;
        ...
        constructor( parentNode:Node, 
            ...
            lightingObstaclesTexture:RenderTexture|null,
            debug:boolean )
        {
            this._lightingMaterial = lightingMaterial;
            this._lightingObstaclesTexture = lightingObstaclesTexture;
            ...
            if(null != lightingMaterial && null != this._lightingObstaclesTexture)
            {
                lightingMaterial.setProperty("lighting_obstacles", this._lightingObstaclesTexture.getGFXTexture());
            }
                        ...
                        if(null != nodePool)
                        {
                            ...
                            else
                            {
                                ...
                                if(graphicsWall != null)
                                {
                                    ...
                                    {
                                        graphicsWall.lightingMaterial = this._lightingMaterial;
                                    }
                                }
                                else
                                {
    ...
    export class MapBuilder extends Component
    {
        ...
        @property (Material)
        LightingMaterial:Material|null = null;
        
        @property (RenderTexture)
        LightingObstaclesTexture:RenderTexture|null = null;
        ...
        createMap()
        {
            ...
            if(null != this._floorPrefab && null != this._wallPrefab)
            {
                ...
                this._map = new LevelMap( this._mapNode, this._width, this._height, this._mapNodeSize, this._floorPrefab, this._wallPrefab, this.LightingMaterial, this.LightingObstaclesTexture, this.Debug );
