import { Maze_BinaryHeapStrategy } from './binaryHeapStrategy.ts';

export namespace Maze_PriorityQueue
{
    ...
    export class PriorityQueue<T>
    {
        ...
        public constructor(options: Options<T>)
        {
            ...
            this.strategy = new Maze_BinaryHeapStrategy.BinaryHeapStrategy(options);
        }
